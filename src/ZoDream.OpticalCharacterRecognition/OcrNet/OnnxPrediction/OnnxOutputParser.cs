...
namespace ZoDream.OpticalCharacterRecognition.OcrNet.OnnxPrediction
{
    class OnnxOutputParser
    {
        ...
        public List<YoloBoundingBox> ParseOutputs(float[] modelOutput, float probabilityThreshold = .3f)
        {
        ...
        public List<YoloBoundingBox> FilterBoundingBoxes(List<YoloBoundingBox> boxes, int limit, float iouThreshold)
        {
